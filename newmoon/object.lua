local object = newmoon.helper.optionaltable("object")
---Create a new object.
...
function object.create(b) b.init={} b.callback={onUse=function() end,tick=function() end} newmoon.mod.currentmod.objects[b.id] = b return b end
